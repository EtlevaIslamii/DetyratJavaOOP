...
{
    //Ofroni konstruktorin që pranon që të tri parametrat, ku inicializohen të gjitha atributet.
    public int isbn;
...
// Ofroni metodën abstrakte kaDetyra që tregon nëse njëlibër ka përmbedhje detyrash 
    public abstract boolean kaDetyra();
// Ofroni metodën që reprezenton në String një Libër në formatin: isbn : titulli – vitiPublikimit
    ...
    //  Ofroni metodën për krahasimin e dy Librave (Dy libra janë të njejtë nëse kanë isbn të njejtë). 
