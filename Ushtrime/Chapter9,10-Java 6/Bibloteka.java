...
public class Bibloteka {
   private String emriBibloteka;
    ...
    private int index=0;
    //d) Një bibliotekë mund të ketë 150 libra (nuk duhet te deklarohet si konstante). 
    ...
    //Klasa e brendshme (ang. Inner class) Romani është një Libër, ka zhanrin, s’ka detyra, reprezentohet në String si
    ...
    //c) Klasa e ndërthurur (ang. static nested class) Fjalori është një Libër, ka numër fjalësh, s’ka detyra, reprezentohet në String si:
    ...
    //e) Çdo Bibliotekë e ka një fjalor shqip – shqip me 570 fjalë, isbn = 11111 i publikuar më 2005

    {
        librat=new Libri[NrLibrave];
        librat[index++]=new Bibloteka.Fjalori(570, 11111, "Fjalori shqip-shqip", 2005);
    }
    ...
    //g) Metoda shtoLibrin e shton një libër në array nëse nuk ekziston dhe ka vend në array 
    ...
    public static void main(String[] args) {
        ...
        LibriShkollor libriShkollor=new LibriShkollor(12345, "Anglia", 2001, "Shkenca Politike");
