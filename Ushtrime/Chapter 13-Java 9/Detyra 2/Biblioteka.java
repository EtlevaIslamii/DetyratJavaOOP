public class Biblioteka{
	...
	//b) Ofroni metodën ekziston e cila tregon nëse një libër gjendet në bibliotekë. Libri ti dërgohet metodës si parametër.
	...
	//c) Ofroni metodën shtoLibrin që e shton një libër në bibliotekë nëse ai veq se nuk ekziston.
	...
	//d) Ofroni metodën maxNumriAutoreve që e kthen enciklopedinë më numrin më të madh të autorëve.
	...
	//e) Ofroni metodën shtypDrejtimin që e shtyp / afishon librat shkollor që e kanë një drejtimi të caktuar. Drejtimi ti dërgohet metodës si parametër.
