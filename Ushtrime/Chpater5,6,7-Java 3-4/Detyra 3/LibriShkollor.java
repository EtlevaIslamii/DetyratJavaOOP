...
public class LibriShkollor extends Libri {
    ...
    //b) Ofroni metodën që reprezenton në String një objekt të klasës LibriShkolor në formatin: Libri Shkollor <isbn> : <titulli> - <vitiPublikimit> : <drejtimi> 

    @Override
    public String toString()
    {
        return "Libri Shkollor<"+this.isbn+">:<"+this.titulli+">-<"+this.vitiPublikimit+">:<"+this.drejtimi+">";
    }
